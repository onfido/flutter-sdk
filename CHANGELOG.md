...
- The iOS SDK is now built with Xcode 26. Integrating this version requires Xcode 26 or newer.
- Update underlying Onfido native SDK versions:
  - Android 23.11.+ (up from 23.8.+)
  - iOS 34.0.+ (up from 33.1.+)

# [10.2.0] - 2026-06-01

- Update underlying Onfido native SDK versions:
  - Android 23.8.+ (up from 23.7.+)
  - iOS 33.1.+ (up from 33.0.1)

# [10.1.0] - 2026-04-22

- Update underlying Onfido native SDK versions:
  - Android 23.7.+ (up from 23.6.+)
  - iOS 33.0.+ (up from 33.0.0)

# [10.0.0] - 2026-03-16

- Update underlying Onfido native SDK versions:
  - Android 23.5.+ (up from 23.6.+)
  - iOS 32.8.+ (up from 32.7.+)
